...
<nav class=" col-sm-12 col-md-3 nav flex-column justify-content-around border-end min-vh-100 position-relative">
    <div class="position-absolute top-0 start-0">
        <div class="sidebar row align-items-center ms-auto">
